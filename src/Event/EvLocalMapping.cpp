...
//                                mbBadImu = true;
                    ...
                    else
                    {
                        ...
                        if (mbOptimize == true) {
                            Optimizer::LocalBundleAdjustment(mpCurrKF, &mbAbortBA, mpCurrKF->GetMap(),
                                                               num_FixedKF_BA, num_OptKF_BA, num_MPs_BA, num_edges_BA);
                        }
...
//                                      mpImuManager->getLastImuBias(), mpCurrKF);
                                            ...
                                            list<ORB_SLAM3::MapPoint*>& mlpRecentAddedMapPoints)
    {
        ...
        // Insert Keyframe in Map // this is already done in insertKF methods
