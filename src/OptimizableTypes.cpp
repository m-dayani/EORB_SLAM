...
namespace ORB_SLAM3 {
    ...
    // **Note: Compare this with EdgeMono in G2oTypes: Why projectJac has a minus and treated differently?
    void EdgeSE3ProjectXYZ::linearizeOplus() {
        g2o::VertexSE3Expmap * vj = dynamic_cast<g2o::VertexSE3Expmap *>(_vertices[1]);
        g2o::SE3Quat T(vj->estimate());
        g2o::VertexSBAPointXYZ* vi = dynamic_cast<g2o::VertexSBAPointXYZ*>(_vertices[0]);
