    ...
    pCamera1(pKF1->mpCamera), pCamera2(pKF2->mpCamera)
{
    ...
    for(int i1=0; i1<mN1; i1++)
    {
        if(vpMatched12[i1])
        {
            ...
            //const cv::KeyPoint &kp1 = pKF1->getUndistKPtMono(indexKF1);
            //const cv::KeyPoint &kp2 = pKFm->getUndistKPtMono(indexKF2);

            const float sigmaSquare1 = pKF1->getKPtLevelSigma2(indexKF1);
            const float sigmaSquare2 = pKFm->getKPtLevelSigma2(indexKF2);
