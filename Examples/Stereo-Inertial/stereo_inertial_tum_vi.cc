...
int main(int argc, char **argv)
{
    ...
    const shared_ptr<EORB_SLAM::MySensorConfig> dsConf = std::make_shared<EORB_SLAM::MySensorConfig>(EORB_SLAM::MySensorConfig::IMU_STEREO);
    shared_ptr<EORB_SLAM::MyCamParams> camParams = std::make_shared<EORB_SLAM::MyCamParams>();
    ...
    ORB_SLAM3::System SLAM(argv[1],argv[2], dsConf, camParams, true, 0, file_name);
